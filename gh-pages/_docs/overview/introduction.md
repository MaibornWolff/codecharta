...
It turns metrics and your code base into a **city-like map**.
Makes your code **tangible**! A map where you can move around and find hotspots where your team has always had problems.
...
CodeCharta was mainly developed by MaibornWolff to help us with our [Software Health Checks](https://www.maibornwolff.de/software-audits).
...
From here you can move around, look at metrics and even print them.
...
To install our [CodeCharta Shell]({{site.baseurl}}{% link _docs/overview/analysis.md %}), simply install it via npm:

...
There are, however, a lot more metrics that can be generated. The [analysis section]({{site.docs_overview}}/analysis) features a list of all available tools. You can click on each tool to see which metrics it can generate.

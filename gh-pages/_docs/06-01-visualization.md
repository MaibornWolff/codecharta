...
>
> Please also be aware that the metrics in the dropdown are tied to the metric sources and the [importers]({{site.baseurl}}{% link _docs/05-03-importers.md %}) you used to generate said map.

...
| `max_function_complexity`         | The highest McCabe's cyclomatic complexity found in any single function.                                      |
...
| `average_function_complexity`     | The mean McCabe's cyclomatic complexity across all functions.                                                 |
...
| `-nc, --not-compressed`         | save the output file uncompressed (as plain .cc.json instead of a gzipped .gz file) |
...
You may use the [CSVImporter](/docs/importer/csv) to import general CSV files.

...
1. [Download](https://docs.sonarqube.org/latest/analysis/scan/sonarscanner/) the latest version of SonarScanner CLI
...
For further information read [here](https://docs.sonarqube.org/latest/user-guide/user-token/)

### Extract project metrics from Sonar Server

To visualize your project metrics created by Sonar use CodeCharta's [sonar importer](/docs/importer/sonar) to generate a `cc.json` file.

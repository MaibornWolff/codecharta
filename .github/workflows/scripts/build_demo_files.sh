...
$CCSH merge -o ../visualization/dist/webpack/codecharta_visualization.cc.json codecharta_sonar_visualization.cc.json codecharta_unified_visualization.cc.json codecharta_git_mod.cc.json
...
# Create one zipped map for pipeline build
$CCSH merge -o ../visualization/dist/webpack/codecharta_analysis.cc.json codecharta_sonar_analysis.cc.json codecharta_unified_analysis.cc.json codecharta_git_mod.cc.json

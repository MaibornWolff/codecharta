...
$CCSH modify --set-root root/visualization -o codecharta_sonar_mod.cc.json codecharta_sonar.cc.json
...
$CCSH modify --set-root root/analysis -o codecharta_sonar_mod.cc.json codecharta_sonar_analysis.cc.json

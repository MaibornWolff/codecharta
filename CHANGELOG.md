...
-   Migrate codeMap.render.service, codeMap.label.service, codeMap.mouseEvent.service, codeMap.arrow.service and CodeCharta.service to Angular [#3094](https://github.com/MaibornWolff/codecharta/pull/3094)

...
internal class CommitCollector private constructor(private val metricsFactory: MetricsFactory) {
    ...
    private fun combineForParallelExecution(firstCommits: MutableList<VersionControlledFile>, secondCommits: MutableList<VersionControlledFile>): MutableList<VersionControlledFile> {
    ...
    companion object {
        ...
        fun create(metricsFactory: MetricsFactory): Collector<Commit, *, MutableList<VersionControlledFile>> {
            ...
            return Collector.of(Supplier<MutableList<VersionControlledFile>> { ArrayList() }, BiConsumer<MutableList<VersionControlledFile>, Commit> { versionControlledFiles, commit -> collector.collectCommit(versionControlledFiles, commit) }, BinaryOperator<MutableList<VersionControlledFile>> { firstCommits, secondCommits -> collector.combineForParallelExecution(firstCommits, secondCommits) })
        }
    }

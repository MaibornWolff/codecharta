...
public class AntlrAbstractSyntaxTreeTest {
    ...
    private JavaParser createSimpleParser() throws IOException {
        return createParserForFile(getClass().getClassLoader().getResource("de/maibornwolff/codecharta/importer/sourcecodeparser/oop/infrastructure/antlr/java/SourceCodeSimple.java").getFile());
    }

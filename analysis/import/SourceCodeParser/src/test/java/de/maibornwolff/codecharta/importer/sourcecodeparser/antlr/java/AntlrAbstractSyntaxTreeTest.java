package de.maibornwolff.codecharta.importer.sourcecodeparser.antlr.java;
...
public class AntlrAbstractSyntaxTreeTest {
    ...
    private JavaParser createSimpleParser() throws IOException {
        return createParserForFile(getClass().getClassLoader().getResource("de/maibornwolff/codecharta/importer/sourcecodeparser/oop/java/SourceCodeSimple.java").getFile());
    }

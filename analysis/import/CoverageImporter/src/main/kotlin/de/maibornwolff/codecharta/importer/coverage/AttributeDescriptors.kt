...
enum class CoverageAttributes(
    ...
    BRANCH_COVERAGE(
        "branch_coverage", AttributeDescriptor(
    ...
    STATEMENT_COVERAGE(
        "statement_coverage", AttributeDescriptor(
    ...
    INSTRUCTION_COVERAGE(
        "instruction_coverage", AttributeDescriptor(
    ...
    COMPLEXITY_COVERAGE(
        "complexity_coverage", AttributeDescriptor(
    ...
    METHOD_COVERAGE(
        "method_coverage", AttributeDescriptor(
    ...
    CLASS_COVERAGE(
        "class_coverage", AttributeDescriptor(
...
internal fun getAttributeTypes(language: Language): AttributeTypes {
    val attributeTypes: MutableMap<String, AttributeType> =
        language.coverageAttributes.associateBy(
            { it.attributeName },
            { it.attributeType }) as MutableMap<String, AttributeType>

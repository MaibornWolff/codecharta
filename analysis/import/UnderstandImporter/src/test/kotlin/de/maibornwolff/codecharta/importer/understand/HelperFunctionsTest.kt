...
class HelperFunctionsTest : Spek({
    ...
    describe("sumOrFirst") {
        listOf(
            ...
            it(
                "calculates sum of ${test.a.javaClass.simpleName} and ${test.b.javaClass.simpleName} " +
            ...
            it(
                "calculates sum of ${test.a} as ${test.a.javaClass.simpleName} and ${test.b} as ${test.b.javaClass.simpleName} " +
                    "to type ${test.result}"
            ) {
    ...
    describe("getMaxValOrFirst") {
        listOf(
            ...
            it(
                "calculates max of ${test.a.javaClass.simpleName} and ${test.b.javaClass.simpleName} " +
                    "to type ${test.result.javaClass.simpleName}"
            ) {
                expect(test.result.javaClass) { sum.javaClass }
            }
            ...
            it(
                "calculates max of ${test.a} as ${test.a.javaClass.simpleName} and ${test.b} as ${test.b.javaClass.simpleName} " +
                    "to type ${test.result}"
            ) {
                if (test.result is Double) {
                    assertThat(sum as Double, closeTo(test.result, 0.01))

...
class CSVProjectBuilderTest {
    ...
    private val csvProjectBuilder = CSVProjectBuilder(
        '\\',
        ',',
        MetricNameTranslator(mapOf(Pair("File Name", "path")))
    )

    private val inputStream = this.javaClass.classLoader.getResourceAsStream("coupling-codemaat.csv")!!
    private val project = csvProjectBuilder

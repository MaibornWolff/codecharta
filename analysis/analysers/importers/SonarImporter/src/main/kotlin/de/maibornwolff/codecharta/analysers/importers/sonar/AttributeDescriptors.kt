...
private fun getAttributeDescriptorsWithNegativeDirection(metricLink: String): Map<String, AttributeDescriptor> = mapOf(
    "accepted_issues" to
        createAttributeDescriptor("Accepted Issues", "Accepted issues", -1, metricLink),
    "blocker_violations" to
        createAttributeDescriptor(
            "Blocker Violations",
            "Total count of issues of the severity blocker",
            -1,
            metricLink
        ),
    "bugs" to
    ...
    "cognitive_complexity" to
        createAttributeDescriptor(
            ...
            "A sonar excluside metric to measure how hard is it to understand the control flow of code",
            -1,
    ...
    "comment_lines_density" to
        createAttributeDescriptor(
            ...
            "Density of comment lines in relation to total lines of code",
            -1,
            metricLink
        ),
    "complexity" to
    ...
    "complexity_in_classes" to
        createAttributeDescriptor(
            "Class Complexity",
            "Cyclomatic complexity of classes",
            -1,
            metricLink
        ),
    ...
    "conditions_to_cover" to
        createAttributeDescriptor(
            "Conditions to Cover",
            "Number of conditions which could be covered by unit tests",
            -1,
            metricLink
        ),
    "confirmed_issues" to
    ...
    "critical_violations" to
        createAttributeDescriptor(
            "Critical Violations",
            "Total count of issues of the severity critical",
            -1,
            metricLink
        ),
    "directories" to
    ...
    "generated_lines" to
        createAttributeDescriptor(
            "Generated Lines",
            "Number of generated lines of code (includes comments and empty lines)",
            -1,
            metricLink
        ),
    "generated_ncloc" to
        createAttributeDescriptor(
            ...
            "Number of generated non-empty lines of code",
            -1,
            metricLink
        ),
    "high_impact_accepted_issues" to
        createAttributeDescriptor(
            ...
            "Accepted issues with high impact",
            -1,
            metricLink
        ),
    "info_violations" to
        createAttributeDescriptor(
            "Info Violations",
            "Total count of issues of the severity info",
            -1,
            metricLink
        ),
    "lines" to
        createAttributeDescriptor(
            "Number of Lines",
            "Number of code lines (number of carriage returns)",
            -1,
            metricLink
        ),
    "lines_to_cover" to
    ...
    "major_violations" to
        createAttributeDescriptor(
            "Major Violations",
            "Total count of issues of the severity major",
            -1,
            metricLink
        ),
    "minor_violations" to
        createAttributeDescriptor(
            "Minor Violations",
            "Total count of issues of the severity minor",
            -1,
            metricLink
        ),
    "ncloc" to
    ...
    "new_conditions_to_cover" to
        createAttributeDescriptor(
            ...
            "Number of new/updated conditions which could be covered by unit tests",
            -1,
            metricLink
        ),
    ...
    "new_development_cost" to
        createAttributeDescriptor(
            ...
            "Development cost of new/updated code",
            -1,
            metricLink
        ),
    "new_duplicated_blocks" to
        createAttributeDescriptor(
            ...
            "Number of duplicated blocks of lines in new/updated code",
            -1,
            metricLink
        ),
    "new_duplicated_lines" to
        createAttributeDescriptor(
            ...
            "Number of lines involved in duplications in new/updated code",
            -1,
            metricLink
        ),
    "new_duplicated_lines_density" to
        createAttributeDescriptor(
            ...
            "Density of duplicated lines in new/updated code",
            -1,
            metricLink
        ),
    ...
    "new_lines" to
        createAttributeDescriptor(
            "Number of New Lines",
            "Number of new/updated lines of code",
            -1,
            metricLink
        ),
    "new_lines_to_cover" to
        createAttributeDescriptor(
            ...
            "Number of new/updated lines of code which could be covered by unit tests",
            -1,
            metricLink
        ),
    ...
    "new_security_hotspots_reviewed_status" to
        createAttributeDescriptor(
            ...
            "Total number of reviewed security hotspots in new code period",
            -1,
            metricLink
        ),
    "new_security_hotspots_to_review_status" to
        createAttributeDescriptor(
            ...
            "Number of security hotspots to review in new code period",
            -1,
            metricLink
        ),
    ...
    "new_uncovered_conditions" to
        createAttributeDescriptor(
            ...
            "Total number of uncovered conditions in new/updated code",
            -1,
            metricLink
        ),
    "new_uncovered_lines" to
        createAttributeDescriptor(
            ...
            "Total number of uncovered lines in new/updated code",
            -1,
            metricLink
        ),
    "new_violations" to
    ...
    "public_undocumented_api" to
        createAttributeDescriptor(
            ...
            "Public undocumented classes, functions and variables available",
            -1,
            metricLink
        ),
    "reopened_issues" to
    ...
    "security_hotspots_reviewed_status" to
        createAttributeDescriptor(
            ...
            "Total number of reviewed security hotspots",
            -1,
            metricLink
        ),
    "security_hotspots_to_review_status" to
        createAttributeDescriptor(
            ...
            "Number of security hotspots to review",
            -1,
            metricLink
        ),
    "skipped_tests" to
    ...
    "test_errors" to
        createAttributeDescriptor(
            ...
            "Number of unit tests that have thrown errors",
            -1,
            metricLink
        ),
    "test_failures" to
    ...
    "uncovered_conditions" to
        createAttributeDescriptor(
            ...
            "Total number of uncovered conditions",
            -1,
            metricLink
        ),
    "uncovered_lines" to
    ...
    "wont_fix_issues" to
        createAttributeDescriptor(
            ...
            "Total count of issues in the wont fix state",
            -1,
            metricLink
        )
)

private fun getAttributeDescriptorsWithPositiveDirection(metricLink: String): Map<String, AttributeDescriptor> = mapOf(
    "branch_coverage" to
        createAttributeDescriptor(
            "Branch Coverage",
            "Density of fully covered boolean conditions in flow control structures",
            1,
            metricLink
        ),
    "coverage" to
    ...
    "line_coverage" to
        createAttributeDescriptor(
            "Line Coverage",
            "Density of fully covered lines of code",
            1,
            metricLink
        ),
    ...
    "new_line_coverage" to
        createAttributeDescriptor(
            ...
            "Density of fully covered lines of new/updated code",
            1,
            metricLink
        ),
    "public_documented_api_density" to
        createAttributeDescriptor(
            ...
            "Public documented classes and functions balanced by rloc",
            1,
            metricLink
        ),
    ...
    "test_success_density" to
        createAttributeDescriptor(
            ...
            "Ratio between successful tests and all tests",
            1,
            metricLink
        ),

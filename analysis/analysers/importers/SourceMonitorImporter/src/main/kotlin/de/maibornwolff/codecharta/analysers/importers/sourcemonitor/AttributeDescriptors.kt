...
internal fun getAttributeDescriptors(): Map<String, AttributeDescriptor> {
    ...
    val analyzerName = setOf("sourceMonitorImporter")
    ...
    descriptors["functions_per_class"] =
        AttributeDescriptor(
            title = "Functions per Class",
            description = "Number of functions per class",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    descriptors["average_statements_per_function"] =
        AttributeDescriptor(
            ...
            description = "Average number of statements per function",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    ...
    descriptors["max_block_depth"] =
        AttributeDescriptor(
            ...
            description = "Maximum nested block depth found",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    descriptors["average_block_depth"] =
        AttributeDescriptor(
            title = "Average Block Depth",
            description = "Average nested block depth found",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    ...
    descriptors["sm_percent_branch_statements"] =
        AttributeDescriptor(
            ...
            description = "Percentage of branch statements",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    descriptors["sm_method_call_statements"] =
        AttributeDescriptor(
            title = "Method Calls",
            description = "Number of method call statements",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    descriptors["sm_percent_lines_with_comments"] =
        AttributeDescriptor(
            ...
            description = "Percentage of code lines that contain comments",
            link = ghLink,
            direction = -1,
            analyzers = analyzerName
        )
    ...
    for (i in 0..9) {
        descriptors["statements_at_level_$i"] =
            AttributeDescriptor(
                ...
                description = "Statements at block level $i",
                link = ghLink,
                direction = -1,
                analyzers = analyzerName
            )

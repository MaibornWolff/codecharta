...
class HotfixCommits : Metric {
    ...
    override fun description(): String = "Hotfix Commits: Number of hotfix commits (containing 'hotfix') for this file."

    override fun metricName(): String = "hotfix_commits"
    ...
    override fun value(): Number = count
}

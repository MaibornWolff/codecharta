...
// when
    ...
    @Test
    fun `should increase by single modification if more additions`() { // given
        val metric = AddedLines()
    ...
    @Test
    fun `should not increase by single modification if more deletes`() { // given
        val metric = AddedLines()
    ...
    @Test
    fun `should increase by multiple modification if more additions`() { // given
        val metric = AddedLines()

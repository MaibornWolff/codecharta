...
internal fun getAttributeDescriptors(): Map<String, AttributeDescriptor> {
    ...
    val analyzerName = setOf("svnLogParser")
    return mapOf(
        "age_in_weeks" to
            AttributeDescriptor(
                title = "Age in Weeks",
                description = "File age in weeks",
                link = ghLink,
                direction = -1,
        ...
        "number_of_renames" to
            AttributeDescriptor(
                ...
                description = "Number of file renames",
                link = ghLink,
                direction = -1,
                analyzers = analyzerName
            ),
        "range_of_weeks_with_commits" to
            AttributeDescriptor(
                ...
                description = "Average number of weeks between commits",
                link = ghLink,
                direction = -1,
                analyzers = analyzerName
            ),
        ...
        "weeks_with_commits" to
            AttributeDescriptor(
                ...
                description = "Number of weeks in which commits occurred",
                link = ghLink,
                direction = -1,
                analyzers = analyzerName
            ),
        ...
        "temporal_coupling" to
            AttributeDescriptor(
                ...
                description = "The degree of temporal coupling between two files (>=35%)",
                link = ghLink,
                direction = -1,
                analyzers = analyzerName
            ),
        "authors" to
            AttributeDescriptor(
                title = "Authors",
                description = "The authors that have worked on a file",
                link = ghLink,
                direction = -1,
                analyzers = analyzerName
            )

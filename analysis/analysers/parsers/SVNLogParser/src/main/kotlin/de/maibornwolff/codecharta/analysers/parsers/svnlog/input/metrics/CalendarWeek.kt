...
internal data class CalendarWeek(private val week: Int, private val year: Int) : Comparable<CalendarWeek> {
    override fun compareTo(other: CalendarWeek): Int = numberOfWeeksBetween(this, other)
    ...
    companion object {
        ...
        fun numberOfWeeksBetween(a: CalendarWeek, b: CalendarWeek): Int =
            ChronoUnit.WEEKS.between(getWeekDate(a.year, a.week), getWeekDate(b.year, b.week)).toInt()
        ...
        private fun isFirstOrSecondWeek(calendarWeek: Int): Boolean = calendarWeek <= 2

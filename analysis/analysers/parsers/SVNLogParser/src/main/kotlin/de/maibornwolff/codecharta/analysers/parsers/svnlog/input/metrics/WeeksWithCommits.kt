...
class WeeksWithCommits : Metric {
    ...
    override fun description(): String = "Weeks With Commits: number of weeks with commits for this file."

    override fun metricName(): String = "weeks_with_commits"

    override fun registerCommit(commit: Commit) {
        weeksWithCommits.add(CalendarWeek.forDateTime(commit.commitDate))
    }

    override fun value(): Number = weeksWithCommits.size

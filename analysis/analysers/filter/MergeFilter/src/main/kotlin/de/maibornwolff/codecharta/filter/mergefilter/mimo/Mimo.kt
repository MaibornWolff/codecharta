package de.maibornwolff.codecharta.analysers.filter.mergefilter.mimo

import de.maibornwolff.codecharta.analysers.filter.mergefilter.ParserDialog
...
class Mimo {
    companion object {
        ...
        fun retrieveGroupName(files: List<String>): String {
            ...
            return runInTerminalSession { ParserDialog.askForMimoPrefix(this, filePrefixes) }
        }

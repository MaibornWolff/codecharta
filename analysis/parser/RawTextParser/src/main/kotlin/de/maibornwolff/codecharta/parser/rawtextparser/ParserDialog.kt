    ...
    companion object : ParserDialogInterface {
        ...
        override fun collectParserArgs(): List<String> {
            ...
            val fileExtensions: String =
                KInquirer.promptInput(message = "Do you only want to parseProject files with specific file-extensions? ", default = "", hint = "fileType1, fileType2... (leave empty to include all file-extensions)")

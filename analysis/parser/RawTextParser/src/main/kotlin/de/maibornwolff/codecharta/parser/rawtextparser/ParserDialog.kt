    ...
    override fun collectParserArgs(): List<String> {
            ...
            val maxIndentationLevel: BigDecimal =
                    KInquirer.promptInputNumber(
                            message = "What is the maximum Indentation Level?", default = "10",
                            hint = "10",
                                               )
            ...
            val exclude: String =
                    KInquirer.promptInput(
                            ...
                            default = "", hint = "regex1, regex2.. (leave empty if you don't want to exclude anything)",
                                         )

            val fileExtensions: String =
                    KInquirer.promptInput(
                            message = "Do you only want to parse files with specific file-extensions? ",
                            default = "", hint = "fileType1, fileType2... (leave empty to include all file-extensions)",
                                         )

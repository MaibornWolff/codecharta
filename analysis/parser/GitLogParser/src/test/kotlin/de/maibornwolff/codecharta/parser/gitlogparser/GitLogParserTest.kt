...
import de.maibornwolff.codecharta.parser.gitlogparser.GitLogParser.Companion.main
...
class GitLogParserTest {
    ...
    fun `should create json uncompressed file log-scan`() {
        ...
        assertEquals(
            ...
            de.maibornwolff.codecharta.parser.gitlogparser.getAttributeDescriptors()
        )
    }

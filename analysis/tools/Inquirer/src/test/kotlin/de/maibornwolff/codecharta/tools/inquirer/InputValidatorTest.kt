...
class InputValidatorTest {
    ...
    fun `should return expectedOutput for files and folders`(
        ...
        assertThat(InputValidator.isFileOrFolderValid(inputType, fileExtensionList)(path)).isEqualTo(expectedValidation)
    }
    ...
    fun `should return expected greater then check`(baseNumber: Int, inputNumber: Int, expectedValidation: Boolean) {
        assertThat(InputValidator.isNumberGreaterThen(baseNumber)(inputNumber.toString())).isEqualTo(expectedValidation)
    }
}

...
const DESTINATION_DIR: string = "codeCharta/state/store/{{camelCase subreducer}}/{{camelCase name}}"
...
export const PLOP_REDUX_FILE_ACTIONS = [
	...
	modifyFileAction({
		filePath: "app/codeCharta/state/state.module.ts",
	...
	modifyFileAction({
		filePath: "app/codeCharta/state/injector.service.ts",
	...
	modifyFileAction({
		filePath: "app/codeCharta/state/store/{{camelCase subreducer}}/{{camelCase subreducer}}.splitter.ts",

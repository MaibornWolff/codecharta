...
import { CoupleHeightAndColorMetricEffect } from "./codeCharta/state/effects/coupleHeightAndColorMetric/coupleHeightAndColorMetric.effect"
...
@NgModule({
	imports: [
		...
		EffectsModule.forRoot([
			...
			CoupleHeightAndColorMetricEffect
		]),
		SliderModule,

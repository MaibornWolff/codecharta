...
describe("app.codeCharta.core.data.deltaCalculatorService", function() {
	...
	beforeEach(
		NGMock.mock.inject(function(_deltaCalculatorService_) {
			deltaCalculatorService = _deltaCalculatorService_
		})
	)
	...
	function decorate(map: CodeMap) {
		DataDecorator.decorateMapWithPathAttribute(map)
		DataDecorator.decorateMapWithOriginAttribute(map)
	}

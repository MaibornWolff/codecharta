...
describe("settings.service", function() {
	...
	it(
		"compute margin should compute correct margins for this map",
		NGMock.mock.inject(function(settingsService: SettingsService) {
	...
	it(
		"compute margin should compute correct margins for this map if dynamicMargin is off",
		NGMock.mock.inject(function(settingsService: SettingsService) {
	...
	it(
		"compute margin should return default margin if metric does not exist",
		NGMock.mock.inject(function(settingsService: SettingsService) {
	...
	it(
		"compute margin should return 100 as margin if computed margin bigger als 100 is",
		NGMock.mock.inject(function(settingsService: SettingsService) {
	 ...
	 */
	it(
		"should retrieve the angular service instance with disabled delta cubes and no details selected",
		NGMock.mock.inject(function(settingsService) {
	 ...
	 */
	it(
		"should retrieve the correct query param strings",
		NGMock.mock.inject(function(settingsService) {
	 ...
	 */
	it(
		"should update settings from url",
		NGMock.mock.inject(function(settingsService, $location) {
	 ...
	 */
	it(
		"should not update settings.map from url",
		NGMock.mock.inject(function(settingsService, $location) {
	 ...
	 */
	it(
		"should react to data-changed events",
		NGMock.mock.inject(function(settingsService, $rootScope) {
	 ...
	 */
	it(
		"should react to camera-changed events",
		NGMock.mock.inject(function(settingsService, $rootScope) {
	 ...
	 */
	it(
		"onCameraChanged should update settings object but not call onSettingsChanged to ensure performance",
		NGMock.mock.inject(function(settingsService) {
	 ...
	 */
	it(
		"should react to data-changed events and set metrics correctly",
		NGMock.mock.inject(function(settingsService, $rootScope) {
			settingsService.onSettingsChanged = sinon.spy()
	 ...
	 */
	it(
		"should return last value when id is bigger than or equal to metrics length",
		NGMock.mock.inject(function(settingsService, $rootScope) {
			var arr = ["a", "b", "c"]
	 ...
	 */
	it(
		"should return correct value when id is smaller than metrics length",
		NGMock.mock.inject(function(settingsService, $rootScope) {
			var arr = ["a", "b", "c"]
	 ...
	 */
	it(
		"should return defaultValue when metric is not in array",
		NGMock.mock.inject(function(settingsService) {
			const arr = ["a", "b", "c"]
	 ...
	 */
	it(
		"should return the searched value when metric is in array",
		NGMock.mock.inject(function(settingsService) {
	 ...
	 */
	it(
		"should replace metric with default if metric is not available",
		NGMock.mock.inject(function(settingsService, dataService) {
	 ...
	 */
	it(
		"should return input if metrics are available",
		NGMock.mock.inject(function(settingsService) {
			const settings = { areaMetric: "a", heightMetric: "b", colorMetric: "c" }
			const result = settingsService.correctSettings(settings)

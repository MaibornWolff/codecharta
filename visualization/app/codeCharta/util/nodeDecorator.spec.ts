...
import { CCFile, MetricData, CodeMapNode, NodeType, AttributeTypeValue, AttributeTypes } from "../codeCharta.model"
...
describe("nodeDecorator", () => {
	...
	describe("decorateMap", () => {
		...
		it("folders should have sum delta values of children for absolute metrics", () => {
			NodeDecorator.decorateMap(deltaMap, metricData, new Blacklist())

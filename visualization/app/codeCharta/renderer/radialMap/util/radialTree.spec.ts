...
describe("buildRadialTree", () => {
    it("should keep folders and files, sizing each folder by the area of all files below it", () => {
        ...
        // Act
        const result = buildRadialTree(root, METRICS, NOTHING_IS_FLAT)
    ...
    it("should mark flattened folders and files", () => {
        ...
        // Act
        const result = buildRadialTree(root, METRICS, isFlat)
    ...
    it("should return null for a map that is a single file", () => {
        // Act
        const result = buildRadialTree(file("/root", { rloc: 10 }), METRICS, NOTHING_IS_FLAT)
    ...
    it("should return null for a map without any area", () => {
        // Act
        const result = buildRadialTree(folder("/root", [file("/root/a.ts", { rloc: 0 })]), METRICS, NOTHING_IS_FLAT)
...
describe("node lookup", () => {
    ...
    it("should find the parent folder in the tree, not by cutting the path", () => {
        // Arrange
        const mergedChain = buildRadialTree(

...
describe("MapTreeViewSearchController", () => {
	...
	function rebuildController() {
		mapTreeViewSearchController = new MapTreeViewSearchController(services.$timeout, services.settingsService, services.dataService)
	}
	...
	describe("Update ViewModel with blacklist count", () => {
		...
		it("should get correct searchedNodePaths with searchedFiles.length", () => {
			...
			expect(mapTreeViewSearchController.settingsService.settings.searchedNodePaths).toEqual([
				"/root/a/ab/aba",
				"/root/a/abc",
				"/root/a/ab"
			])

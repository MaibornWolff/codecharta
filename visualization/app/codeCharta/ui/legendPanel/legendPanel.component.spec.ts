...
describe("LegendPanelController", () => {
	...
	describe("Color to pixel image", () => {
		it("generate pixel in base64", () => {
			expect(legendPanelController.generatePixel("some color value")).toBe(
				"data:image/gif;base64,R0lGODlhAQABAPAAsome color value/yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="
			)
		})

		it("html -> base64", () => {
			expect(legendPanelController.getImageDataUri("000000")).toBe(

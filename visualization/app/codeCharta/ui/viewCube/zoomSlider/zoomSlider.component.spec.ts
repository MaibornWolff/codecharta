...
describe("ZoomSliderComponent", () => {
    const mockedThreeMapControlsService = {
        MAX_ZOOM: 200,
        MIN_ZOOM: 10,
        zoomPercentage$: of(100),
        setZoomPercentage: jest.fn()
    }

    beforeEach(() => {
        mockedThreeMapControlsService.zoomPercentage$.subscribe = jest.fn()
    ...
    it("should not exceed the maximum zoom", async () => {
        mockedThreeMapControlsService.zoomPercentage$ = of(200)
        await render(ZoomSliderComponent)
    ...
    it("should not go below the minimum zoom", async () => {
        mockedThreeMapControlsService.zoomPercentage$ = of(10)
        await render(ZoomSliderComponent)

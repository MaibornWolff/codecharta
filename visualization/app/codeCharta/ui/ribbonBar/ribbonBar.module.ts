...
@NgModule({
	imports: [AreaMetricChooserModule, HeightMetricChooserModule, ColorMetricChooserModule],
	entryComponents: [AreaMetricChooserComponent, HeightMetricChooserComponent, ColorMetricChooserComponent]
})

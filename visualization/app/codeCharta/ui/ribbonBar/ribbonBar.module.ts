...
import { CoupleHeightAndColorMetricButtonModule } from "./coupleHeightAndColorMetricButton/coupleHeightAndColorMetricButton.module"
...
@NgModule({
	imports: [
		...
		CoupleHeightAndColorMetricButtonModule,

...
describe("AddCustomScenarioDialogComponent", () => {
    beforeEach(async () => {
        return TestBed.configureTestingModule({
            imports: [AddCustomScenarioDialogComponent, StoreModule.forRoot(appReducers, { metaReducers: [setStateMiddleware] })],
            providers: [
    ...
    it("should validate scenario's name", async () => {
        ...
        const { container } = await render(AddCustomScenarioDialogComponent)
    ...
    it("should show an error message when no properties are selected", async () => {
        const { detectChanges } = await render(AddCustomScenarioDialogComponent)

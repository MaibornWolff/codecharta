...
export class RibbonBarController {
	private collapsingElements = $(
		"code-map-component #codeMap, ribbon-bar-component #metrics-panel, ribbon-bar-component .section-body, #toggle-ribbon-bar-fab, reset-settings-button-component .md-button"
	)

...
import { CodeMapNode, FlattenedNode, NodeType } from "../../../model/codeCharta.model"
import { removeFlattenedNodes } from "../../../stores/sharedView/sharedView.write.facade"
import { CategorizedMetricDistribution, NO_EXTENSION, OTHER_EXTENSION } from "../../../util/fileExtension/fileExtensionCalculator"
import { ruleForExtensionsPattern } from "../effects/extensionRule/extensionRule.effect"
import { ExtensionRulesStore } from "../stores/extensionRules.store"
...
export class ExtensionRulesService {
    ...
    private createFlattenedItemsMap(flattenedItems: FlattenedNode[]): Map<string, FlattenedNode> {

...
import { LoadingIndicatorEffect } from "./setLoadingIndicator/setLoadingIndicator.effect"
 ...
 */
export const codeMapEffects = [RenderCodeMapEffect, AutoFitCodeMapEffect, LoadingIndicatorEffect]

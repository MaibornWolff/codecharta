...
import { setDomainBarSizeRange } from "./sizeRange.actions"

export const defaultSizeRange: WordCloudSettings["sizeRange"] = defaultWordCloudSettings.sizeRange
export const sizeRange = createReducer(defaultSizeRange, on(setDomainBarSizeRange, setState(defaultSizeRange)))

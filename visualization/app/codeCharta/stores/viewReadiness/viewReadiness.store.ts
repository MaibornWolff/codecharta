...
/** The routed views that own content and therefore own a readiness state. Mirrors `routePaths`. */
export type ViewId = "metrics" | "domain"

const VIEW_IDS: readonly ViewId[] = ["metrics", "domain"]

...
import { setDomainStateRotationStep } from "./rotationStep.actions"

export const defaultRotationStep: WordCloudSettings["rotationStep"] = defaultWordCloudSettings.rotationStep
export const rotationStep = createReducer(defaultRotationStep, on(setDomainStateRotationStep, setState(defaultRotationStep)))

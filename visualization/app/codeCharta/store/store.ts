import { preferences } from "../stores/preferences/preferences.read.facade"
import { files } from "../stores/fileStore/store/files.reducer"
import { isLoadingFile } from "../stores/fileStore/store/isLoadingFile/isLoadingFile.reducer"
import { currentFilesAreSampleFiles } from "../stores/fileStore/store/currentFilesAreSampleFiles/currentFilesAreSampleFiles.reducer"
import { mapState } from "../stores/mapState/mapState.read.facade"
import { sharedView } from "../stores/sharedView/sharedView.read.facade"
import { metricsLensSource } from "../stores/metricsLensSource/metricsLensSource.read.facade"
import { dependencyLensSource } from "../stores/dependencyLensSource/dependencyLensSource.read.facade"

...
- The color ramp under the COLOR axis classifies bins exactly like the 3D map (a bin at the upper threshold is negative) and respects the selected gradient color mode.

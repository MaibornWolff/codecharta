...
- **The Domain tab stays reachable in compare mode**: it used to bounce you straight back to the map. Picking it now leaves compare mode — the domain view shows a single word cloud — and says so with a toast. Only a file set without domain data still returns you to the map view.

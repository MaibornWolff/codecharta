...
- **Explorer reaches the bottom bar in the domain view**: After visiting the map view, the file explorer in the domain view stopped short of the bottom bar. It kept reserving room for the map view's file-extension bar, which the domain view does not have.
